    ...
    <div>
      <div className="working-project p-4 sm:p-16 grid sm:flex justify-between md:flex gap-10 sm:gap-0 md:gap-0 overflow-hidden">
        <div className="f-w-project relative w-full max-w-[708px] ">
          {/* TEXT OVERLAY */}
          <a href="https://mkframework.shop/" target="_blank" className="overflow-text absolute inset-0 flex flex-col justify-between p-6">
            {/* TOP - COMPANY NAME */}
        ...
        <div className="f-w-project relative w-full max-w-[708px] ">
          {/* TEXT OVERLAY */}
          <a href="/" target="_blank" className="overflow-text absolute inset-0 flex flex-col justify-between p-6">
            {/* TOP - COMPANY NAME */}
            <div className="f-o-v-text text-white font-bold text-lg md:text-2xl">
              Company Name
            </div>
